...
conv1 = Conv2D(16, 3, activation='relu')(inputIm)
pool1 = MaxPool2D()(conv1)
flat = Flatten()(pool1)
...
checkpoint = ModelCheckpoint('fried_noodles_best7.h5', verbose=1, monitor='val_mean_absolute_error', save_best_only=True, mode='min')
...
# Test
model = load_model('fried_noodles_best7.h5')
